...
If no actions are provided, you should still describe the current state as best as you can as it will be the environment's initial state.
...
You do not need to provide any details about what the agent should do, just describe the current state and the legal actions available to the agent.
